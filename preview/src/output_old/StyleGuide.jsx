      ...
      <div className="p-8 max-w-6xl mx-auto">
        ...
        <section id="components" className="mb-16">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card variant="flat" className="p-6">
                ...
                <p className="text-gray-500">
                  This card has a flat background color.
                </p>
              </Card>
              ...
              <Card variant="interactive" className="p-6">
                ...
                <p className="text-gray-500">
                  This card has hover effects to indicate it's interactive.
                </p>
              </Card>
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-md">
                    <p className="text-sm">
                      This is an example of nested content in a modal.
                    </p>
                  </div>
                </div>
              </Modal>
              ...
              <Dropdown
                ...
                items={[
                  { type: 'label', label: 'Actions' },
                  {
                    type: 'item',
                    label: 'Edit',
                    props: { onSelect: () => console.log('Edit') },
                  },
                  {
                    type: 'item',
                    label: 'Duplicate',
                    props: { onSelect: () => console.log('Duplicate') },
                  },
                  { type: 'separator' },
                  {
                    type: 'item',
                    label: 'Delete',
                    props: { onSelect: () => console.log('Delete') },
                  },
                ]}
              />
            </div>
          ...
          <div className="mb-12">
            ...
            >
              <p>
                Content sections help organize your page content with consistent
                spacing and typography. You can use them for articles,
                documentation, or any text-heavy content.
              </p>
              <h4>Features</h4>
              <ul>
              ...
              <p>
                This component uses Tailwind's typography plugin for rich text
                formatting.
              </p>
            </ContentSection>
          </div>
