...
const allVariantStyles = JSON.parse('{"base":{"root":"bg-white rounded-lg shadow-md p-6","elements":{},"description":"Base card component with rounded corners and subtle shadow"}}');
