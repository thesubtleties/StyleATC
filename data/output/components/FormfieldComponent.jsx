...
const allVariantStyles = JSON.parse('{"default":{"root":"w-full flex-col justify-start space-y-2","elements":{"fieldset":"mb-4 flex flex-col gap-1.5","label":"block text-[13px] leading-none mb-2.5 text-gray-700 font-medium","input":"h-[35px] shrink-0 grow rounded px-2.5 text-[15px] leading-none outline-none shadow-sm border border-gray-300 bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500"},"description":"Default FormField variant."},"cosmic":{"root":"","elements":{"fieldset":"space-y-3 p-3 rounded-lg bg-gradient-to-b from-indigo-950 to-purple-950 max-w-md mx-auto","label":"text-blue-200 font-medium uppercase tracking-wider","input":"h-[40px] w-full rounded-md px-3 text-[15px] leading-none outline-none shadow-inner border border-indigo-500 bg-indigo-900/60 text-white placeholder:text-indigo-300/60 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/50 focus:bg-indigo-900/80 disabled:cursor-not-allowed disabled:bg-indigo-950 disabled:text-indigo-400/50 backdrop-blur-sm"},"description":"A cosmic, space-themed form field with starry accents and futuristic styling."},"ocean":{"root":"w-full flex-col justify-start space-y-2 w-full flex-col justify-start space-y-2 bg-[#0ea5e9] text-#0c4a6e focus:ring-[#0ea5e9]","elements":{"input":"h-[35px] shrink-0 grow rounded-md bg-blue-50 px-2.5 text-[15px] leading-none outline-none shadow-sm border-2 border-blue-300 placeholder:text-blue-400 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500","label":"block text-[13px] leading-none mb-2.5 text-blue-700 font-medium","fieldset":"mb-4 flex flex-col gap-1.5 text-blue-800"},"description":"An ocean-inspired form field with cool blue colors and a subtle wave-like appearance"}}');
