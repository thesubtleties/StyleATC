...
const allVariantStyles = JSON.parse('{"default":{"root":"w-full flex-col justify-start space-y-2","elements":{"fieldset":"mb-4 flex flex-col gap-1.5","label":"block text-[13px] leading-none mb-2.5 text-gray-700 font-medium","input":"h-[35px] shrink-0 grow rounded px-2.5 text-[15px] leading-none outline-none shadow-sm border border-gray-300 bg-white focus:border-primary-500 focus:ring-1 focus:ring-primary-500 disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500"},"description":"Default FormField variant."},"cosmic":{"root":"","elements":{"fieldset":"space-y-3 p-3 rounded-lg bg-gradient-to-b from-indigo-950 to-purple-950","label":"text-blue-200 font-medium uppercase tracking-wider","input":"h-[40px] shrink-0 grow rounded-md px-3 text-[15px] leading-none outline-none shadow-inner border border-indigo-500 bg-indigo-900/60 text-white placeholder:text-indigo-300/60 focus:border-purple-400 focus:ring-2 focus:ring-purple-400/50 focus:bg-indigo-900/80 disabled:cursor-not-allowed disabled:bg-indigo-950 disabled:text-indigo-400/50 backdrop-blur-sm"},"description":"A cosmic, space-themed form field with starry accents and futuristic styling."}}');
