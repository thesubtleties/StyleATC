...
const allVariantStyles = JSON.parse('{"default":{"root":"w-[300px] rounded-md shadow-[0_2px_10px] shadow-black/5 bg-white","elements":{"item":"mt-px overflow-hidden first:mt-0 first:rounded-t last:rounded-b focus-within:relative focus-within:z-10 focus-within:shadow-[0_0_0_2px] focus-within:shadow-black/10","trigger":"group flex h-[45px] flex-1 cursor-default items-center justify-between px-5 text-[15px] leading-none shadow-[0_1px_0] shadow-black/10 outline-none hover:bg-opacity-80 bg-white","icon":"text-gray-500 h-4 w-4","content":"overflow-hidden text-[15px] data-[state=closed]:animate-slideUp data-[state=open]:animate-slideDown bg-white text-gray-700"},"description":"Default accordion variant."}}');
