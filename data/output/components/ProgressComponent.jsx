...
const allVariantStyles = JSON.parse('{"default":{"root":"relative h-3 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-gray-700","elements":{"indicator":"h-full w-full flex-1 bg-blue-500 dark:bg-blue-400 transition-all shadow-sm"},"description":"Default progress variant."},"ocean":{"root":"relative h-4 w-full overflow-hidden rounded-full bg-blue-100/50 hover:animate-focusPulse group","elements":{"indicator":"h-full w-full bg-gradient-to-r from-blue-400 via-blue-600 to-indigo-500 shadow-md group-hover:animate-zoomInLeft"},"description":"An ocean-themed progress bar with light background and gradient fill"},"modern":{"root":"relative h-3 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700/40","elements":{"indicator":"h-full w-full bg-gradient-to-r from-violet-500 to-fuchsia-500 shadow-[0_0_5px_rgba(139,92,246,0.5)]"},"description":"A sleek, modern progress bar with soft glow effect"},"minimal":{"root":"relative h-2 w-full overflow-hidden rounded-sm bg-gray-100 dark:bg-gray-800","elements":{"indicator":"h-full w-full bg-green-500 dark:bg-green-400 transition-all duration-500"},"description":"A minimal, flat progress bar with subtle animation"}}');
